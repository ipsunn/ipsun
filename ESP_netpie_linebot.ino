...
const char* host = "https://test-line1.herokuapp.com/bot.php";//change this to your linebot server ex.http://numpapick-linebot.herokuapp.com/bot.php
#define APPID   "Linetest"     //change this to your APPID
#define KEY     "JqllYZOvtng54EL"     //change this to your KEY
#define SECRET  "pRC7MMjtM2XmYPhEcM6eBbgP0"     //change this to your SECRET
